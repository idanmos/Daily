...
struct Activity: CustomDebugStringConvertible {
    ...
    var activityType: String {
        if activity.walking {
            return Localization.walking.preferredLocalization
        }
        else if activity.running {
            return Localization.running.preferredLocalization
        }
        else if activity.automotive {
            return Localization.driving.preferredLocalization
        }
        else if activity.cycling {
            return Localization.cycling.preferredLocalization
        }
        else if activity.stationary {
            return Localization.stationary.preferredLocalization
        }
        else {
            return "Unknown"
        }
